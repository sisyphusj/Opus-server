...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
    ...
    final ErrorResponse response = ErrorResponse.of(ResponseCode.INVALID_INPUT_VALUE,
        String.valueOf(sb));
   ...
   *
   * @param e MissingRequestHeaderException return ResponseEntity<ErrorResponse>
   */
  ...
  protected ResponseEntity<ErrorResponse> handleMissingServletRequestParameterException(
    ...
    final ErrorResponse response = ErrorResponse.of(ResponseCode.REQUEST_PARAMETER_NOT_VALID,
        e.getMessage());
    return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
  }
  ...
  protected ResponseEntity<ErrorResponse> handleResponseStatusException(ResponseStatusException e) {
    ...
    final ErrorResponse response = ErrorResponse.of(e.getStatusCode().value(), e.getMessage(),
        e.getReason());
